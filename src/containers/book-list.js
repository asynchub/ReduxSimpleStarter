...
// I CONTAINER
// having data and view make component to be smart one: container
...
// forge the connection between redux (app state) and actual component
...
// define the function that maps state to props
